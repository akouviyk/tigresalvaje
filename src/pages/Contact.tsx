      ...
      <section className="bg-deep-marine py-20">
        <div className="section-container">
          ...
          <p className="text-xl text-sandstone text-center max-w-3xl mx-auto">
            We'd love to hear from you. Whether you have questions, want to partner, or just want to say hello.
          </p>
        </div>
      </section>
        ...
        <div className="section-container">
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-16">
            ...
            <div className="bg-sandstone p-8 rounded-lg text-center">
              ...
              <h3 className="text-xl font-serif text-deep-marine mb-3">Email</h3>
              <a 
              ...
              <p className="text-sm text-coastal-sage">Response time: 24–48 hours</p>
            </div>

            {/* WhatsApp */}
            <div className="bg-sandstone p-8 rounded-lg text-center">
              <div className="text-5xl mb-4">💬</div>
              <h3 className="text-xl font-serif text-deep-marine mb-3">WhatsApp</h3>
              <a 
              ...
              <p className="text-sm text-coastal-sage">Preferred for quick questions</p>
            </div>

            {/* Address */}
            <div className="bg-sandstone p-8 rounded-lg text-center">
              <div className="text-5xl mb-4">📍</div>
              <h3 className="text-xl font-serif text-deep-marine mb-3">Visit Us</h3>
              <p className="text-driftwood text-sm mb-2">
                Tigre Salvaje<br />
                Punta Burica, Barú District<br />
                Chiriquí Province, Panama
              </p>
              <p className="text-sm text-coastal-sage">35-minute hike from Bella Vista</p>
            </div>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-sandstone p-8 rounded-lg">
              <h2 className="text-3xl font-serif text-deep-marine mb-6">Send Us a Message</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-driftwood mb-2">Name *</label>
                    <input
                      type="text"
                      required
                      value={formData.name}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-driftwood mb-2">Email *</label>
                    <input
                      type="email"
                      required
                ...
                <div>
                  <label className="block text-sm font-medium text-driftwood mb-2">Subject *</label>
                  <select
                    required
                ...
                <div>
                  <label className="block text-sm font-medium text-driftwood mb-2">Message *</label>
                  <textarea
                    required
                    rows={6}
        ...
        <div className="section-container max-w-4xl">
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={i} className="bg-white p-6 rounded-lg">
        ...
        <div className="section-container">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-sm text-coastal-sage mt-4">
              Note: No paved road access. Visitors arrive via 35-minute hike from Bella Vista.
            </p>
          </div>
        </div>
      </section>
