...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: '#24582a', color: '#fffaf1' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-coastal-sage text-sm">
              Protecting endangered sea turtles and wildlife at Punta Burica,
              Panama since 2005.
            </p>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-sunset-coral">
              Quick Links
            </h4>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  to="/donate"
                  className="text-coastal-sage hover:text-hatchling-olive transition-colors"
                >
                  Donate
                </Link>
              </li>
        ...
        <div className="border-t border-coastal-sage mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-coastal-sage">
          <p>
            © 2025 Tigre Salvaje Conservation Foundation. All rights reserved.
          </p>
        ...
        <div className="mt-8 text-xs text-coastal-sage text-center">
          <p>
            Tigre Salvaje operates under Panama's wildlife protection laws (Ley
            371/2023). We do not purchase eggs for resale. All field handling is
            performed under permit or via community rescue programs.
          </p>
        </div>
      </div>
    </footer>
