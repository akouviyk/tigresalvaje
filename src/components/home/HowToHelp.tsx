        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div
              ...
              style={{
                background:
                  'linear-gradient(to bottom right, #24582a, #d4e8cf)',
              }}
            >
              <svg
            ...
            <div className="p-6">
              ...
              <p className="text-driftwood mb-4">
                One-time or monthly. Every $50 sponsors a nest. PayPal or credit
                card.
              </p>
              <Link
                to="/donate"
          ...
          >
            <div
              ...
              style={{
                background:
                  'linear-gradient(to bottom right, #d4e8cf, #d4e8cf)',
              }}
            >
              <svg
                className="w-24 h-24 text-white"
          ...
          >
            <div
              ...
              style={{
                background:
                  'linear-gradient(to bottom right, #24582a, #24582a)',
              }}
            >
              <svg
                className="w-24 h-24 text-white"
            ...
            <div className="p-6">
              ...
              <p className="text-driftwood mb-4">
                Walk the beach, relocate eggs, release hatchlings. $35/day (week
                1).
              </p>
              <Link
                to="/volunteer"
          ...
          >
            <div
              ...
              style={{
                background:
                  'linear-gradient(to bottom right, #d4e8cf, #24582a)',
              }}
            >
              <svg
                className="w-24 h-24 text-white"
